...
#
#  This function has been deprecated in favor of stringr::str_flatten()
# function.
#
# This function concatenates multiple strings into a single string using a
# specified delimiter and provides the option to change the delimiter for the
# last pair of strings.
#
